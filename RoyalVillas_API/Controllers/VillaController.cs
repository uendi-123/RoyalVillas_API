...
namespace RoyalVilla_API.Controllers
{
    ...
    public class VillaController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<VillaDTO>>>> GetVillas()
        {
            ...
            var response=ApiResponse<IEnumerable<VillaDTO>>.Ok(dtoResponseVilla, 
                "Villa retriewed Successfully");
        ...
        public async Task<ActionResult<ApiResponse<VillaDTO>>> GetVillaById(int id)
        {
            try
            {
                ...
                return Ok(ApiResponse<VillaDTO>.Ok(_mapper.Map<VillaDTO>(villa), "Villa retriewed Successfully"));
        ...
        public async Task<ActionResult<ApiResponse<VillaDTO>>> CreateVilla(VillaCreateDTO villaDTO)
        {
            try
            {
                ...
                var dublicateVilla = await _db.Villa.FirstOrDefaultAsync(u => u.Name.ToLower() == villaDTO.Name.ToLower());
                ...
                var response = ApiResponse<VillaDTO>.CreateAt(_mapper.Map<VillaDTO>(villa), "Villa created successfully");
